...
<div class="container-fluid">
    <div class="card conatiner-card">
        <div class="card-header container-card--header">
            <span class="float-left">Listagem de Objetivos</span>
            <button class="btn" onclick="window.location.href = '<?=url("admin/objetivos/create")?>'" >Novo cadastro</button>
        </div>
        <div class="card-body">
        <table class="table">
            ...
            <tbody>
            <?php foreach($objetivos as $key => $objetivo):?>
                <tr>
                <th scope="row"><?=$objetivo->data->id?></th>
                <td><?=$objetivo->data->nome?></td>
                <td>
                    <a href="<?=url("admin/objetivos/editar?id={$objetivo->data->id}")?>">
