...
<div class="d-flex">
    ...
    <div class="container_center">
        <div class="container-header__texto">
            <span>Editando Cidade</span>
        </div>
        <form class="row" method="post" id="form-usuario">
            <input type="hidden" name="id" value="<?=$cidades[0]->data->id?>">
            <div class="form-group mt-2">
                <label for="nome">Nome</label>
                <input class="form-control" type="text" name="nome" id="nome" value="<?=$cidades[0]->data->nome?>">
            </div>
